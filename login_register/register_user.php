...
<head>
    ...
    <style>
        /* Enhanced Register User Page Styles - Blue Theme */
        :root {
            --primary-blue: #0d6efd;
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="auth_register_user.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">🏷️ Real Name <span class="text-danger">*</span></label>
                                        ...
                                        <div class="row gx-3 mb-3 align-items-center">
                                            <div class="col-md-9">
                                                <label class="form-label">🖼️ User Image (Optional)</label>
                                        ...
                                        <div class="d-grid mt-4">
                                            <button class="btn btn-primary" type="submit" id="registerBtn">Register As A User</button>
                                        </div>
                                    </form>
                                </div>
