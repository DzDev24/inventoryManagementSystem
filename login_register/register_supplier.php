                        ...
                        <div class="col-lg-8">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center">
                                    <h3 class="fw-light my-4">Supplier Registration</h3>
                                </div>
                                <div class="card-body">
                                    <form action="auth_register_supplier.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                        ...
                                        <div class="row gx-3 mb-3 align-items-center">
                                            <div class="col-md-9">
                                                <label class="form-label">Supplier Image (Optional)</label>
                                        ...
                                        <div class="d-grid mt-4">
                                            <button class="btn btn-primary" type="submit">Register As A Supplier</button>
                                        </div>
                                    </form>
                                </div>
