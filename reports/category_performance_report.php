  ...
  <script>
    (async () => {
      ...
      const cards = [{
          ...
          value: summary.top_revenue_category,
          icon: 'fa-chart-line',
          color: '#3b82f6'
        },
        {
          title: 'Top Margin Category',
          value: summary.top_margin_category,
          icon: 'fa-percent',
          color: '#10b981'
        },
        {
          title: 'Most Products Category',
          value: summary.most_products_category,
          icon: 'fa-boxes',
          color: '#f59e0b'
        },
        {
