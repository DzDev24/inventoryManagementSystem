...
(async () => {
  ...
  const statCards = [
    { title: 'Total Customers', value: summary.total_customers, icon: 'fas fa-users', color: '#4f46e5' },
    { title: 'Most Valuable Customer', value: summary.top_customer, icon: 'fas fa-crown', color: '#f59e0b' },
    { title: 'Avg Spend per Customer', value: 'DA ' + summary.avg_spend.toLocaleString(), icon: 'fas fa-money-bill-wave', color: '#10b981' },
    { title: 'New Customers This Month', value: summary.new_customers, icon: 'fas fa-user-plus', color: '#3b82f6' }
  ];
