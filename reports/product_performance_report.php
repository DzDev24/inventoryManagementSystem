...
(async () => {
  ...
  const cards = [
    { title: 'Best Seller', value: summary.best_product, icon: 'fa-star', color: '#10b981' },
    { title: 'Total Units Sold', value: summary.total_units, icon: 'fa-cubes', color: '#3b82f6' },
    { title: 'Total Revenue', value: `$${summary.total_revenue}`, icon: 'fa-dollar-sign', color: '#f59e0b' },
    { title: 'Least Seller', value: summary.worst_product, icon: 'fa-box-open', color: '#ef4444' },
  ];
