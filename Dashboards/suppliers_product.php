...
$similar_stmt = $conn->prepare(
    "SELECT p.Product_ID, p.Product_Name, p.Buy_Price, m.File_Path
     FROM products p
     LEFT JOIN media m ON p.Media_ID = m.Media_ID
    ...
    <div class="product-container position-relative">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="mb-4">
                <span class="price-tag"><?= number_format($product['Buy_Price'], 2) ?> DA</span>
                </div>
...
<div class="d-grid gap-2 mb-4">
    ...
    <div class="d-grid">
        <form action="add_to_proposals.php" method="POST" class="w-100 m-0">
            <input type="hidden" name="product_id" value="<?= $product['Product_ID'] ?>">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
    <th class="bg-light">Buy Price</th>
    <td><?= number_format($product['Buy_Price'], 2) ?> DA</td>
</tr>
                        ...
                        <div class="row">
                            <?php foreach ($similar_products as $similar): ?>
                                <div class="col-6 mb-3">
                                    <a href="suppliers_product.php?id=<?= $similar['Product_ID'] ?>" class="text-decoration-none">
                                        <div class="card h-100 border-0 shadow-sm">
                                            ...
                                            <div class="card-body p-2">
                                                ...
                                                <p class="card-text text-primary mb-0"><?= number_format($similar['Buy_Price'], 2) ?> DA</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
