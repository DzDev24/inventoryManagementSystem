            ...
            <div class="nav accordion" id="accordionSidenav">
                ...
                <div class="collapse" id="collapseDashboards" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                        ...
                        <a class="nav-link" href="dashboard-2.php">Multipurpose</a>
                        <a class="nav-link" href="dashboard-3.php">Affiliate</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapsePages" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                        ...
                        <div class="collapse" id="pagesCollapseAuth" data-bs-parent="#accordionSidenavPagesMenu">
                            <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesAuth">
                                ...
                                <div class="collapse" id="pagesCollapseAuthBasic" data-bs-parent="#accordionSidenavPagesAuth">
                                    <nav class="sidenav-menu-nested nav">
                                        <a class="nav-link" href="auth-login-basic.php">Login</a>
                                        <a class="nav-link" href="auth-register-basic.php">Register</a>
                                        <a class="nav-link" href="auth-password-basic.php">Forgot Password</a>
                                    </nav>
                                </div>
                                ...
                                <div class="collapse" id="pagesCollapseAuthSocial" data-bs-parent="#accordionSidenavPagesAuth">
                                    <nav class="sidenav-menu-nested nav">
                                        <a class="nav-link" href="auth-login-social.php">Login</a>
                                        <a class="nav-link" href="auth-register-social.php">Register</a>
                                        <a class="nav-link" href="auth-password-social.php">Forgot Password</a>
                                    </nav>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="pagesCollapseError" data-bs-parent="#accordionSidenavPagesMenu">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="error-400.php">400 Error</a>
                                <a class="nav-link" href="error-401.php">401 Error</a>
                                <a class="nav-link" href="error-403.php">403 Error</a>
                                <a class="nav-link" href="error-404-1.php">404 Error 1</a>
                                <a class="nav-link" href="error-404-2.php">404 Error 2</a>
                                <a class="nav-link" href="error-500.php">500 Error</a>
                                <a class="nav-link" href="error-503.php">503 Error</a>
                                <a class="nav-link" href="error-504.php">504 Error</a>
                            </nav>
                        </div>
                ...
                <div class="collapse" id="collapseApps" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavAppsMenu">
                        ...
                        <div class="collapse" id="appsCollapseKnowledgeBase" data-bs-parent="#accordionSidenavAppsMenu">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="knowledge-base-home-1.php">Home 1</a>
                                <a class="nav-link" href="knowledge-base-home-2.php">Home 2</a>
                                <a class="nav-link" href="knowledge-base-category.php">Category</a>
                                <a class="nav-link" href="knowledge-base-article.php">Article</a>
                            </nav>
                        </div>
                ...
                <div class="collapse" id="collapseFlows" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav">
                        <a class="nav-link" href="multi-tenant-select.php">Multi-Tenant Registration</a>
                        <a class="nav-link" href="wizard.php">Wizard</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                        ...
                        <div class="collapse" id="collapseLayoutSidenavVariations" data-bs-parent="#accordionSidenavLayout">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.php">Static Sidenav</a>
                                <a class="nav-link" href="layout-dark.php">Dark Sidenav</a>
                                <a class="nav-link" href="layout-rtl.php">RTL Layout</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayoutContainers" data-bs-parent="#accordionSidenavLayout">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-boxed.php">Boxed Layout</a>
                                <a class="nav-link" href="layout-fluid.php">Fluid Layout</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayoutsPageHeaders" data-bs-parent="#accordionSidenavLayout">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="header-simplified.php">Simplified</a>
                                <a class="nav-link" href="header-compact.php">Compact</a>
                                <a class="nav-link" href="header-overlap.php">Content Overlap</a>
                                <a class="nav-link" href="header-breadcrumbs.php">Breadcrumbs</a>
                                <a class="nav-link" href="header-light.php">Light</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayoutsStarterTemplates" data-bs-parent="#accordionSidenavLayout">
                            <nav class="sidenav-menu-nested nav">
                                <a class="nav-link" href="starter-default.php">Default</a>
                                <a class="nav-link" href="starter-minimal.php">Minimal</a>
                            </nav>
                        </div>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseComponents" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="avatars.php">Avatars</a>
                        ...
                        <a class="nav-link" href="modals.php">Modals</a>
                        <a class="nav-link" href="navigation.php">Navigation</a>
                        <a class="nav-link" href="progress.php">Progress</a>
                        <a class="nav-link" href="step.php">Step</a>
                        <a class="nav-link" href="timeline.php">Timeline</a>
                        <a class="nav-link" href="toasts.php">Toasts</a>
                        <a class="nav-link" href="tooltips.php">Tooltips</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseUtilities" data-bs-parent="#accordionSidenav">
                    <nav class="sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="borders.php">Borders</a>
                        <a class="nav-link" href="lift.php">Lift</a>
                        <a class="nav-link" href="shadows.php">Shadows</a>
